            ...
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                <form method="post">
                    <div class="space-y-12">
                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                            <div class="mt-10 grid grid-cols-3 gap-x-6 gap-y-8 sm:grid-cols-6">
                                ...
                                <div class="sm:col-span-3">
                                    <label for="in" class="block text-sm font-medium leading-6 text-gray-900">تاريخ الدخول</label>
                                    <div class="mt-2">
                        ...
                        <div class="sm:col-span-3">
                            <label for="out" class="block text-sm font-medium leading-6 text-gray-900">تاريخ الخروج</label>
                            <div class="mt-2">
