...
<body>
        ...
        <nav class="bg-gray-800">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                <a href="./new_appoint.php" class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">حجز جديد</a>
                    ...
                    <a href="./logout.php" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">تسجيل خروج</a>
                </nav>   
                ...
                <h1 class="text-3xl font-bold tracking-tight text-gray-900">حجز جديد</h1>
            </div>
        </header>
        <main class="">
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                <form method="post">
                    <div class="space-y-12">
                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                            <div class="mt-10 grid grid-cols-3 gap-x-6 gap-y-8 sm:grid-cols-6">
                                ...
                                <div class="sm:col-span-2">
                                    <div class="mt-2.5">
                                        <label for="type" class="block text-sm font-semibold leading-6 text-gray-900">نوع الغرفه</label>
                                        <div class="mt-2">
                                ...
                                <div class="sm:col-span-2">
                                    <div class="mt-2.5">
                                        <label for="number" class="block text-sm font-semibold leading-6 text-gray-900">رقم الغرفه</label>
                                        <div class="mt-2">
                            ...
                            <div class="sm:col-span-2">
                                    <div class="mt-2.5">
                                        <label for="price" class="block text-sm font-medium leading-6 text-gray-900">سعر / ليله</label>
                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                            <div class="mt-10 grid grid-cols-3 gap-x-6 gap-y-8 sm:grid-cols-6">
                                ...
                                <div class="sm:col-span-3">
                                    <label for="in" class="block text-sm font-medium leading-6 text-gray-900">تاريخ الوصول</label>
                                    <div class="mt-2">
                        ...
                        <div class="sm:col-span-3">
                            <label for="out" class="block text-sm font-medium leading-6 text-gray-900">تاريخ المغادره</label>
                            <div class="mt-2">
                        ...
                        <div class="sm:col-span-2">
                            <label for="night" class="block text-sm font-medium leading-6 text-gray-900">الليالى</label>
                            <div class="mt-2.5">
                        ...
                        <div class="sm:col-span-2">
                                    <label for="Payed" class="block text-sm font-medium leading-6 text-gray-900">المدفوع</label>
                                    <div class="mt-2">
                        ...
                        <div class="sm:col-span-2">
                                    <label for="remind" class="block text-sm font-medium leading-6 text-gray-900">الباقي</label>
                                    <div class="mt-2">
                            ...
                            <div class="mt-10 grid grid-cols-3 gap-x-6 gap-y-8 sm:grid-cols-6">
                                ...
                                <div class="sm:col-span-2">
                                    <label for="c1_n" class="block text-sm font-medium leading-6 text-gray-900">العميل الاول</label>
                                    <div class="mt-2">
                                ...
                                <div class="sm:col-span-2">
                                    <label for="c1_ph" class="block text-sm font-medium leading-6 text-gray-900">رقم الهاتف</label>
                                    <div class="mt-2">
                                ...
                                <div class="sm:col-span-2">
                                    <label for="c1_id" class="block text-sm font-medium leading-6 text-gray-900">الرقم القومي</label>
                                    <div class="mt-2">
                                ...
                                <div class="sm:col-span-2">
                                    <label for="c2_n" class="block text-sm font-medium leading-6 text-gray-900">العميل الثاني</label>
                                    <div class="mt-2">
                                ...
                                <div class="sm:col-span-2">
                                    <label for="c2_ph" class="block text-sm font-medium leading-6 text-gray-900">رقم الهاتف</label>
                                    <div class="mt-2">
                                ...
                                <div class="sm:col-span-2">
                                    <label for="c2_id" class="block text-sm font-medium leading-6 text-gray-900">الرقم القومي</label>
                                    <div class="mt-2">
                                ...
                                <div class="sm:col-span-2">
                                    <label for="c3_n" class="block text-sm font-medium leading-6 text-gray-900">العميل الثالث</label>
                                    <div class="mt-2">
                                ...
                                <div class="sm:col-span-2">
                                    <label for="c3_ph" class="block text-sm font-medium leading-6 text-gray-900">رقم الهاتف</label>
                                    <div class="mt-2">
                                ...
                                <div class="sm:col-span-2">
                                    <label for="c3_id" class="block text-sm font-medium leading-6 text-gray-900">الرقم القومي</label>
                                    <div class="mt-2">
                                ...
                                <div class="col-span-full">
                                    <label for="comment" class="block text-sm font-medium leading-6 text-gray-900">ملاحظات</label>
                                    <div class="mt-2">
                                        <textarea placeholder="اضف ملاحظات" id="comment" name="comment" rows="3" class="font-bold p-7 block w-full rounded-md border-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-500 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
                                    </div>
                                </div>
                    </div>
            </div>
    ...
    <div class="mt-6 flex items-center justify-end gap-x-6 m-6">
        ...
        <button type="submit" name="Save" class="  rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">اضافه و حفظ</button>
    </div>
    </form>
    </div>
    </main>
