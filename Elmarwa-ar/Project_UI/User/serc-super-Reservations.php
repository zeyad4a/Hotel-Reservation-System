    ...
    <div class="min-h-full">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="./super-Reservations.php" class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">الحجوزات</a>
        ...
        <header class="bg-white shadow">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <h1 class="text-3xl font-bold tracking-tight text-gray-900">الحجوزات</h1>
            </div>
        </header>
        <main class="">
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                <form class="space-y-6 flex flex-wrap p-3" action="./serc-super-Reservations.php" method="POST">
                ...
                <table class=" table table-striped table-hover table-bordered border-gray-400">
                    ...
                    <tbody class="table-group-divider">
                        <?php
                        $search = $_POST['input'];
                        $sql = mysqli_query($connect, "SELECT * from appointment join rooms on rooms.id=appointment.roomID where check_in = CURRENT_DATE() AND r_number LIKE '%$search%' OR client_name LIKE '%$search%' ");
