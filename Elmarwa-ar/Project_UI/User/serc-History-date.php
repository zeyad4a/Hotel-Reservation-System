    ...
    <nav class="bg-gray-800">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="./History.php" class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">سجل الحجوزات</a>
                    ...
                    <a href="./logout.php" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-1 py-2 text-sm font-medium">سجيل خروج</a>
                </div>
            </div>
        </nav>
        ...
        <main class="">
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                    ...
                    <form class="space-y-12 flex flex-wrap p-3" action="./serc-History-date.php" method="POST">
                        <div class="px-3 py-1.5">
                            <div class="mt-2">
                                ...
                                <label for="Search" class="flex text-sm font-medium text-gray-900">الي</label>
                ...
                <thead>
                        <tr>
                            <th scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">اسم العميل</p>
                            </th>
                            <th scope="col">
                            ...
                            <th scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">تاريخ الوصول</p>
                            </th>
                            <th scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">تاريخ المغادرة</p>
                            </th>
                            <th scope="col">
                            ...
                            <th scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">انهاء</p>
                            </th>
                        </tr>
                    </thead>
                        ...
                        while ($row = mysqli_fetch_array($sql)) {
                            ...
                            <tr>
                                ...
                                <th scope="col">
                                        ...
                                        <p class="text-lg leading- font-bold text-gray-900 text-center">
                                        <a href="./Reminds.php" class=" text-lg inline-flex items-center rounded-md bg-green-50  px-2 py-1 font-medium text-red-700 ring-1 ring-inset ring-red-600/20"> دفع المتبقي </a>
                                        </p>
