            ...
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                ...
                <thead>
                    ...
                    <tbody class="table-group-divider">
                        <?php
                        $search = $_POST['input'];
                        $sql = mysqli_query($connect, "SELECT * FROM appointment join rooms on rooms.id=appointment.roomID WHERE remind !=0 And client_name LIKE '%$search%' ORDER BY apid DESC " );
