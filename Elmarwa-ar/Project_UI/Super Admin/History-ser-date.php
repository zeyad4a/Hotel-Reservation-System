                            ...
                            <th scope="col">
                                ...
                                <th scope="col">
                                        <?php if (($row['apstatue'] == 1) && ($row['remind'] == 0)) { ?>
                                            <p class="text-lg leading- font-bold text-gray-900 text-center"> 
                                        <a href="./History.php?id=<?php echo $row['apid']; ?>&rid=<?php echo $row['id']; ?>&cancel=update" onClick="return confirm('Are You Sure You Want To End This Reservation ?');" class=" text-lg inline-flex items-center rounded-md bg-green-50  px-2 py-1 font-medium text-red-700 ring-1 ring-inset ring-red-600/20"> انهاء الحجز </a>
                                            </p>
