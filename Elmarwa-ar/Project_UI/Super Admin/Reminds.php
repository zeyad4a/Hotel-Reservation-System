                        ...
                        while ($row = mysqli_fetch_array($sql)) {
                            ...
                            <tr>
                                ...
                                <th scope="col">
                                        ...
                                        <a href="./Reminds.php?id=<?php echo $row['apid'] ?>&cancel=update" onClick="return confirm('Pay Remind ?');" class=" text-lg inline-flex items-center rounded-md bg-green-50  px-2 py-1 font-medium text-red-700 ring-1 ring-inset ring-red-600/20"> انهاء </a>
                                            </p>
                                </th>
                            </tr>
                    </tbody>
