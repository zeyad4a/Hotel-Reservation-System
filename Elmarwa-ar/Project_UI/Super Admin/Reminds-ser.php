    ...
    <nav class="bg-gray-800">
                ...
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <a href="./super-Dashboard.php"><img class="h-13 w-16" src="./photo/logoz.png"></a>
                        </div>
        ...
        <main class="">
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                <form class="space-y-6 flex flex-wrap p-3" action="./Reminds-ser.php" method="POST">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">دفع الباقي</p>
                            </th>
                        </tr>
                    </thead>
                        ...
                        while ($row = mysqli_fetch_array($sql)) {
                            ...
                            <tr>
                                ...
                                <th scope="col">
                                        ...
                                        <a href="./Reminds.php?id=<?php echo $row['apid'] ?>&cancel=update" onClick="return confirm('Pay Remind ?');" class=" text-lg inline-flex items-center rounded-md bg-green-50  px-2 py-1 font-medium text-red-700 ring-1 ring-inset ring-red-600/20"> نهاء </a>
                                            </p>
                                </th>
                            </tr>
                    </tbody>
