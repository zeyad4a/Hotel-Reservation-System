        ...
        <div class="min-h-full">
                    ...
                    <div class="flex h-16 items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div class="ml-10 flex items-baseline space-x-4">
                                <a href="./super-Dashboard.php" class="bg-gray-900 text-white rounded-md px-1 py-2 text-sm font-medium" aria-current="page">لوحه التحكم</a>
            ...
            <header class="bg-white shadow">
                <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                    <h1 class="text-3xl font-bold tracking-tight text-gray-900">لوحه التحكم</h1>
                </div>
            </header>
            <main class="">
                            ...
                            <div class="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                                ...
                                <div class="group relative">
                                    <div class="aspect-h-1 aspect-w-1 overflow-hidden rounded-md bg-gray-200 transition-all  hover:bg-sky-300 lg:aspect-none lg:h-48 ">
                                        ...
                                        <p class=" text-lg leading- font-bold text-center text-black p-1"> حجوزات اليوم </p>
                                ...
                                <div class="group relative">
                                    <div class="aspect-h-1 aspect-w-1 overflow-hidden rounded-md bg-gray-200 transition-all  hover:bg-sky-300  lg:aspect-none lg:h-48 ">
                                        ...
                                        <p class=" text-lg leading- font-bold text-center text-black p-1"> الحجوزات التي تنتهي اليوم </p>
                                        <p class=" text-lg leading- font-bold text-center text-black p-1"> [ <?php echo $count = $result->fetch_row()[0]; ?> ]</p>
                                    </div>
                                </div>
                                ...
                                <div class="group relative">
                                    <div class="aspect-h-1 aspect-w-1 overflow-hidden rounded-md bg-gray-200 transition-all  hover:bg-sky-300  lg:aspect-none lg:h-48 ">
                                        ...
                                        <p class=" text-lg leading- font-bold text-center text-black p-1"> عدد الغرف الفرديه الموفره </p>
                                        <p class=" text-lg leading- font-bold text-center text-black p-1"> [ <?php echo $count = $result->fetch_row()[0]; ?> ]</p>
                                    </div>
                                </div>
                                ...
                                <div class="group relative">
                                    <div class="aspect-h-1 aspect-w-1 overflow-hidden rounded-md bg-gray-200 transition-all  hover:bg-sky-300  lg:aspect-none lg:h-48 ">
                                        ...
                                        <p class=" text-lg leading- font-bold text-center text-black p-1"> عدد الغرف الزوجيه المتوفره  </p>
                                        <p class=" text-lg leading- font-bold text-center text-black p-1"> [ <?php echo $count = $result->fetch_row()[0]; ?> ]</p>
                                    </div>
                                </div>
                                ...
                                <div class="group relative">
                                    <div class="aspect-h-1 aspect-w-1 overflow-hidden rounded-md bg-gray-200 transition-all  hover:bg-sky-300  lg:aspect-none lg:h-48 ">
                                        ...
                                        <p class=" text-lg leading- font-bold text-center text-black p-1"> عدد الغرف الثلاثيه المتوفره </p>
                                        <p class=" text-lg leading- font-bold text-center text-black p-1"> [ <?php echo $count = $result->fetch_row()[0]; ?> ]</p>
                                    </div>
                                </div>
                                ...
                                <div class="group relative">
                                    <div class="aspect-h-1 aspect-w-1 overflow-hidden rounded-md bg-gray-200 transition-all  hover:bg-sky-300  lg:aspect-none lg:h-48 ">
                                        ...
                                        <p class=" text-lg leading- font-bold text-center text-black p-1"> الغرف التي في الصيانه </p>
                                        <p class=" text-lg leading- font-bold text-center text-black p-1"> [ <?php echo $count = $result->fetch_row()[0]; ?> ]</p>
                                    </div>
                                </div>
                                ...
                                <div class="group relative">
                                    <div class="aspect-h-1 aspect-w-1 overflow-hidden rounded-md bg-gray-200 transition-all  hover:bg-sky-300  lg:aspect-none lg:h-48 ">
                                        ...
                                        <p class=" text-lg leading- font-bold text-center text-black p-1"> الغرف غير النضيفه </p>
                                        <p class=" text-lg leading- font-bold text-center text-black p-1"> [ <?php echo $count = $result->fetch_row()[0]; ?> ]</p>
                                    </div>
                                </div>
                                ...
                                <div class="group relative">
                                    <div class="aspect-h-1 aspect-w-1 overflow-hidden rounded-md bg-gray-200 transition-all  hover:bg-sky-300  lg:aspect-none lg:h-48 ">
                                        ...
                                        <p class=" text-lg leading- font-bold text-center text-black p-1"> الموظفين النشطين </p>
                                        <p class=" text-lg leading- font-bold text-center text-black p-1"> [ <?php echo $count = $result->fetch_row()[0]; ?> ]</p>
                                    </div>
                                </div>
                                ...
                                <div class="group relative">
                                    <div class="aspect-h-1 aspect-w-1 overflow-hidden rounded-md bg-gray-200 transition-all  hover:bg-sky-300 lg:aspect-none lg:h-48 ">
                                        ...
                                        <p class=" text-lg leading- font-bold text-center text-black p-1"> اجمالى المدفوعات </p>
                                        <p class=" text-lg leading- font-bold text-center text-black p-1"> [ <?php echo $count = $result->fetch_row()[0]; ?> ]</p>
                                    </div>
                                </div>
