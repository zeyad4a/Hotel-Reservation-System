...
<body>
    ...
    <nav class="bg-gray-800">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="./super-user-log.php" class="bg-gray-900 text-white rounded-md px-1 py-2 text-sm font-medium" aria-current="page">السمتخدمين</a>
        ...
        <header class="bg-white shadow">
            ...
            <h1 class="text-3xl font-bold tracking-tight text-gray-900">السمتخدمين</h1>
            </div>
        </header>
        <main class="">
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                ...
                <thead>
                        <tr>
                            <th scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">معرف المستخدم</p>
                            </th>
                            <th scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">اسم الموظف</p>
                            </th>
                            <th scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">حاله الموظف</p>
                            </th>
                            <th scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">المدفوعات</p>
                            </th>
                            <th scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">حذف المستخدم</p>
                            </th>
                        </tr>
                    </thead>
                    <tbody class="table-group-divider">
                        <?php
                        $sql = mysqli_query($connect, "SELECT * FROM employ GROUP BY id" );
                            ...
                            <tr>
                                ...
                                <th scope="col">
                                    <p class="text-lg leading- font-bold text-gray-900 text-center">
                                        ...
                                        ?>
                                            <button class="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-lg font-medium text-red-700 ring-1 ring-inset ring-red-600/20">`غير متاح`</button>
                                        <?php } ?>
                                    </p>
                                </th>
                                <th scope="col">
                                    <p class="text-lg leading- font-bold text-gray-900 text-center"><a href="./super-Payments.php?employId=<?php echo $row['id']; ?>" class="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-lg font-medium text-green-700 ring-1 ring-inset ring-green-600/20">عرض</a></p>
                                </th>
                                <th scope="col">
                                    <p class=" text-lg leading- font-bold text-gray-900 text-center">
                                <a href="./super-user-log.php?id=<?php echo $row['id'] ?>&cancel=update" onClick="return confirm('Are You Sure You Want To Delete ?');" class=" text-lg inline-flex items-center rounded-md bg-green-50  px-2 py-1 font-medium text-red-700 ring-1 ring-inset ring-red-600/20"> مسح </a>
                                </p>
                            </th>
                            </tr>
                    </tbody>
