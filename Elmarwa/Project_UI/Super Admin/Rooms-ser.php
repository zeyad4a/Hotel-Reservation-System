...
if (isset($_GET['cancel'])) {
    ...
    echo "<script>alert('Room Deleted Successful');</script>";
  }
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="./Rooms.php" class="bg-gray-900 text-white rounded-md px-1 py-2 text-sm font-medium" aria-current="page">Rooms</a>
            ...
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                <form class="space-y-6 flex flex-wrap p-3" action="./Rooms-ser.php" method="POST">
                    ...
                    <thead>
                        <tr>
                            <th scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">Room ID</p>
                            </th>
                            <th scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">Room Type</p>
                            </th>
                            <th scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">Statue</p>
                            </th>
                            <th scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">Delete</p>
                            </th>
                        </tr>
                    </thead>
                            ...
                            <tr>
                                ...
                                <th scope="col">
                                    <p class="text-lg leading- font-bold text-gray-900 text-center">
                                        <a href="./Rooms.php?id=<?php echo $row['id']; ?>&Done=update" onClick="return confirm('Are You Sure ?');" class=" text-lg inline-flex items-center rounded-md bg-green-50  px-2 py-1 font-medium text-black ring-1 ring-inset ring-red-600/20"> Done </a>
                                        ...
                                        <a href="./Rooms.php?id=<?php echo $row['id']; ?>&Rapier=update" onClick="return confirm('Are You Sure Room Is Rapiered ?');" class=" text-lg inline-flex items-center rounded-md bg-green-50  px-2 py-1 font-medium text-green-700 ring-1 ring-inset ring-red-600/20"> Rapier </a>
                                        <?php
                                        if (($row['statue'] == 0)) {
                                            ?>
                                            <button class="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-lg font-medium text-blue-700 ring-1 ring-inset ring-red-600/20">`Available`</button>
                                        <?php } else if (($row['statue'] == 1)) {
                                            ?>
                                            <button class="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-lg font-medium text-purple-900 ring-1 ring-inset ring-green-600/20">`Not Available (Busy)`</button>
                                            <?php } else if (($row['statue'] == 2)) {
                                            ?>
                                            <button class="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-lg font-medium text-red-700 ring-1 ring-inset ring-green-600/20">`Not Available (Not Clean)`</button>
                                            <?php } else if (($row['statue'] == 3)) {
                                            ?>
                                            <button class="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-lg font-medium text-red-700 ring-1 ring-inset ring-green-600/20">`Not Available (Rapier)`</button>
                                            <?php } ?>
                                        </p>
                                </th>
                                <th scope="col">
                                    <p class=" text-lg leading- font-bold text-gray-900 text-center">
                                <a href="./Rooms.php?romid=<?php echo $row['id'] ?>&cancel=update" onClick="return confirm('Are You Sure You Want To Delete ?');" class=" text-lg inline-flex items-center rounded-md bg-green-50  px-2 py-1 font-medium text-red-700 ring-1 ring-inset ring-red-600/20"> Delete </a>
                                </p>
                            </th>
                            </tr>
                    </tbody>
