    ...
    <div class="min-h-full">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="./History.php" class="bg-gray-900 text-white rounded-md px-1 py-2 text-sm font-medium" aria-current="page">History</a>
        ...
        <header class="bg-white shadow">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <h1 class="text-3xl font-bold tracking-tight text-gray-900">Appointment	History</h1>
            </div>
        </header>
        <main class="">
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-wrap w-full">
                    ...
                    <form class="space-y-6 flex flex-wrap p-3" action="./History-ser.php" method="POST">
                        ...
                        <div class="px-3 py-1.5">
                            <button name="search1" type="submit" class="flex w-20 justify-center rounded-md bg-blue-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Search</button>
                        </div>
                    </form>
                        ...
                        <div class="px-3 py-1.5">
                            <button name="search2" type="submit" class="flex w-20 justify-center rounded-md bg-blue-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Search</button>
                        </div>
                    </form>
               ...
               <table id="zxc" class=" w-full table table-striped table-hover table-bordered border-gray-400">
                    <thead>
                        <tr>
                        <th scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">Client Name</p>
                            </th>
                            <th scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">Client Phone</p>
                            </th>
                            <th scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">Client ID</p>
                            </th>
                            <th scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">Check In</p>
                            </th>
                            <th scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">Check Out</p>
                            </th>
                            <th scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">Comment</p>
                            </th>
                            <th scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">Print</p>
                            </th>
                            <th scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">by</p>
                            </th>
                            <th scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">End</p>
                            </th>
                        </tr>
                    </thead>
                    <tbody class="table-group-divider">
                        ...
                        while ($row = mysqli_fetch_array($sql)) {
                            ...
                            <th scope="col">
                                ...
                                <th scope="col">
                                    <form method="get">
                                        <p class="text-lg leading- font-bold text-gray-900 text-center"><a href="./receipt.php?id=<?php echo $row['apid']; ?>" class="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-lg font-medium text-green-700 ring-1 ring-inset ring-green-600/20">View</a></p>
                                    </form>
                                </th> 
                                <th scope="col">
                                    <p class="text-lg leading- font-bold text-gray-900 text-center">
                                ...
                                <th scope="col">
                                        <?php if (($row['apstatue'] == 1) && ($row['remind'] == 0)) { ?>
                                            <p class="text-lg leading- font-bold text-gray-900 text-center"> 
                                        <a href="./History.php?id=<?php echo $row['apid']; ?>&rid=<?php echo $row['id']; ?>&cancel=update" onClick="return confirm('Are You Sure You Want To End This Reservation ?');" class=" text-lg inline-flex items-center rounded-md bg-green-50  px-2 py-1 font-medium text-red-700 ring-1 ring-inset ring-red-600/20"> End </a>
                                            </p>
                                        <?php } else if (($row['apstatue'] == 1) && ($row['remind'] != 0)) { ?>
                                        <p class="text-lg leading- font-bold text-gray-900 text-center">
                                        <a href="./Reminds.php" class=" text-lg inline-flex items-center rounded-md bg-green-50  px-2 py-1 font-medium text-red-700 ring-1 ring-inset ring-red-600/20"> Pay Remaind </a>
                                        </p>
                                        <?php } else if (($row['apstatue'] == 0)) { ?>
                                            <p class="text-lg leading- font-bold text-gray-900 text-center">
                                            <button class=" text-lg inline-flex items-center rounded-md bg-green-50  px-2 py-1 font-medium text-blue-700 ring-1 ring-inset ring-blue-600/20"> Ended </button>
                                            </p>
                                </th>
                            </tr>
                    </tbody>
                ...
                <button class=" text-lg inline-flex items-center rounded-md bg-green-50  px-2 py-1 font-medium text-blue-700 ring-1 ring-inset ring-blue-600/20" onclick="printTable()">Print Table</button>
<script>
    function printTable() {
