                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="./super-Payments.php" class="bg-gray-900 text-white rounded-md px-1 py-2 text-sm font-medium" aria-current="page">Payments</a>
                    ...
                    if (mysqli_num_rows($rxxx) > 0) {
                        while ($zxc = mysqli_fetch_assoc($rxxx)) {
                            ...
                            <caption class="caption-bottom border-2 border-gray-400 transition ease-in-out delay-150 bg-gray-300 hover:bg-gray-400 duration-200">
                                <p class=" text-lg leading- font-bold text-center text-black p-1"> Total Payments [ <?php echo $total; ?> ]</p>
                        <?php }
                    } ?>
                            </caption>
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">
                                        <p class="text-lg leading- font-bold text-gray-900 text-center">Nights</p>
                                    </th>
                                    <th scope="col">
                            ...
                            <tbody class="table-group-divider">
                                <?php
                                $search = $_POST['input'];
                                $sql = mysqli_query($connect, "SELECT * from `appointment` join rooms on rooms.id=appointment.roomID where `employId` = '$id' AND check_in = CURRENT_DATE() AND employname LIKE '%$search%' ");
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <th scope="col">
                                            <p class="text-lg leading- font-bold text-gray-900 text-center"><a href="./receipt.php?id=<?php echo $row['apid'];?>&uid=<?php echo $row['userId'];?>" class="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-lg font-medium text-green-700 ring-1 ring-inset ring-green-600/20">View</a></p>
                                        </th>
                                    </tr>
                            </tbody>
                        <?php } ?>
