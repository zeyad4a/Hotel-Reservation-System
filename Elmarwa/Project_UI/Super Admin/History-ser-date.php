            ...
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
               ...
               <table id="zxc" class=" w-full table table-striped table-hover table-bordered border-gray-400">
                    ...
                    <tbody class="table-group-divider">
                        ...
                        $in = $_POST['input2'];
                        $out = $_POST['input3'];
                        $sql = mysqli_query($connect, "SELECT * from appointment join rooms on rooms.id=appointment.roomID WHERE  check_in BETWEEN '$in' AND '$out' ORDER BY apid DESC");
                        while ($row = mysqli_fetch_array($sql)) {
                            ...
                            <th scope="col">
                                ...
                                <th scope="col">
                                        ...
                                        <p class="text-lg leading- font-bold text-gray-900 text-center">
                                        <a href="./Reminds.php" class=" text-lg inline-flex items-center rounded-md bg-green-50  px-2 py-1 font-medium text-red-700 ring-1 ring-inset ring-red-600/20"> Pay Remind </a>
                                        </p>
                ...
                <button class=" text-lg inline-flex items-center rounded-md bg-green-50  px-2 py-1 font-medium text-blue-700 ring-1 ring-inset ring-blue-600/20" onclick="printTable()">Print</button>
<script>
    function printTable() {
