                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                <a href="./new_appoint.php" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-1 py-2 text-sm font-medium">New Appointment</a>
                                ...
                                <a href="./History.php" class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">History</a>
        ...
        <main class="">
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-wrap w-full">
                    ...
                    <form class="space-y-6 flex flex-wrap p-3" action="./serc-History.php" method="POST">
                        ...
                        <div class="px-3 py-1.5">
                            <button name="search" type="submit" class="flex w-20 justify-center rounded-md bg-blue-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Search</button>
                                        ...
                                        <form class="space-y-12 flex flex-wrap p-3" action="./serc-History-date.php" method="POST">
                        <div class="px-3 py-1.5">
                            <div class="mt-2">
                ...
                <table id="zxc" class=" w-full table table-striped table-hover table-bordered border-gray-400">
                    ...
                    <tbody class="table-group-divider">
                        ...
                        $in = $_POST['input2'];
                        $out = $_POST['input3'];
                        $sql = mysqli_query($connect, "SELECT * from appointment join rooms on rooms.id=appointment.roomID WHERE client_name LIKE '%$search%' OR client_phone LIKE '%$search%' OR client_id LIKE '%$search%' ORDER BY apid DESC");
                        while ($row = mysqli_fetch_array($sql)) {
                            ...
                            <tr>
                                ...
                                if (isset($_GET['cancel'])) {
                                    ...
                                    mysqli_query($connect, "update doctors set statue ='2' where id = " . $_GET['rid'] . "");
