    ...
    <div class="min-h-full">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="./Reminds.php" class="bg-gray-900 text-white rounded-md px-1 py-2 text-sm font-medium" aria-current="page">Reminds</a>
                            </div>
                        </div>
                    </div>
        ...
        <header class="bg-white shadow">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <h1 class="text-3xl font-bold tracking-tight text-gray-900">Reminds</h1>
            </div>
        </header>
        <main class="">
                ...
                <table class=" table table-striped table-hover table-bordered border-gray-400">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">Remind</p>
                            </th>
                            <th scope="col">
                                <p class="text-lg leading- font-bold text-gray-900 text-center">Pay</p>
                            </th>
                        </tr>
                    </thead>
                        ...
                        while ($row = mysqli_fetch_array($sql)) {
                            ...
                            <tr>
                                ...
                                <th scope="col">
                                        ...
                                        <a href="./Reminds.php?id=<?php echo $row['apid'] ?>&cancel=update" onClick="return confirm('Pay Remind ?');" class=" text-lg inline-flex items-center rounded-md bg-green-50  px-2 py-1 font-medium text-red-700 ring-1 ring-inset ring-red-600/20"> End </a>
                                            </p>
                                </th>
                            </tr>
                    </tbody>
